        ...
        <table id="example" class="table table-striped" style="width:100%">
            ...
            <c:forEach items="${movieList}" var="movie">
                <tr>
                    ...
                    <td>
                        <button type="button" onclick="location.href='/admin?action=update&id=${movie.getId()}';"
                                class="btn btn-warning">Update
                        </button>
                    </td>
                    <td>
                        <button type="button" onclick="location.href='/admin?action=delete&id=${movie.getId()}';"
